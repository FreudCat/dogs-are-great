...
export default class RenderCanines extends Component {
  ...
  render() {
    const {name, reference_image_id, bred_for, temperament, weight, height, life_span} = this.props.canineInfo;
    console.log(weight);
    return(
        ...
        <Card className="canine-card">
          <CardBody>
            ...
            <Col xs={12} className="mb-3">
              <GetRandomImage canineName={name} canineImageID={reference_image_id}/>
            ...
            <Col>
              ...
              <button className="cardDropdownHeader w-100 btn btn-outline-primary" onClick={this.toggle} data-event={2}>Height and Weight <i className={`fa fa-chevron-down ${this.state.col === 2 ? "rotate-chevron" : ""}`}></i></button>
                ...
                <CardBody>Height: {height.imperial} inches <br/>
                Weight: {weight.imperial} pounds</CardBody>
                </Collapse>
              </Card>
              <Card>
